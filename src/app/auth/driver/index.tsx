...
export default function LoginDriver() {
  ...
  async function handleLogin() {
    ...
    try {
      const response = await fetch(`${process.env.EXPO_PUBLIC_API_URL}/auth/drivers/login`, {
        method: 'POST',
        headers: {
      ...
      if (responseParsed.error == 'AUS-LD01' || responseParsed.error == 'AUS-LD02') {
      ...
      if (responseParsed?.data?.token) {
        ...
        return router.replace('/driver/home');
      }
    ...
    >
      ...
      >
        <View style={styles.headerContainer}>
          ...
          <Text style={styles.subtitle}>Acessar conta VanPass - Motorista</Text>
        </View>
